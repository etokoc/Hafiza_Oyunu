...
public class OrtaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridLayout = findViewById(R.id.orta_gridView);
...
//                    buttons.get(a).setImageResource(images.get(varolanlar.get(a - 3)));
                    buttonVeri.put(buttons.get(a), images.get(varolanlar.get(a - 5)));
                }
                break;
            }
        }
